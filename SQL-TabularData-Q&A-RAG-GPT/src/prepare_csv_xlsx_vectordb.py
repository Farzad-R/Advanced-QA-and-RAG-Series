...
class PrepareVectorDBFromCSV:
    """
    This class is designed to prepare a vector database from a CSV file.
...
if __name__=="__main__":
    ...
    # Create an instance of the PrepareVectorDBFromCSV class with the file directory
    data_prep_instance = PrepareVectorDBFromCSV(file_directory=titanic_dir)
